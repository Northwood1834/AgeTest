...
test("withheld games leave new selection but remain loadable for saved sessions",async()=>{
  const ids=["calculation-balance-scale-v1","inhibition-parity-v1","language-notice-trim-v1","memory-phone-pin-v1","memory-table-restore-v1","prediction-card-combo-v1","social-care-package-v1","social-postcard-send-v1","spatial-cube-v1","spatial-draw-bridge-v1","spatial-suitcase-pack-v1","timing-mochi-pound-v1"];
